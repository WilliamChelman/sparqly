...
const ALL_SPECS: ReadonlyArray<CommandSpec<never>> = [
  ...
  cacheStatsSpec as unknown as CommandSpec<never>,
  ...
  indexSpec as unknown as CommandSpec<never>,
